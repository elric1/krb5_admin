...
"del_label            - remove a label from a host",
...
"add_host_owner       - add an owner to a logical host",
"remove_host_owner    - remove an owner from a logical host ",
"query_host_owner     - show the owner of a logical host ",
